...
class Lianjia_Spider(scrapy.Spider):
    ...
    '''
    start_urls=[
                'https://m.lianjia.com/bj/xiaoqu/',
                'https://m.lianjia.com/gz/xiaoqu/',
                'https://m.lianjia.com/sz/xiaoqu/',
                'https://m.lianjia.com/tj/xiaoqu/'
                ]
    '''
    ...
    def start_requests(self):
        ...
        for city in self.city_link:
            ...
            #time.sleep(10)
        '''
        url = 'https://m.lianjia.com/hui/xiaoqu/'
    ...
    def parse(self, response):
        ...
        for i in range(1, pages):
            url = 'https://m.lianjia.com/hui/xiaoqu/pg%d/?_t=1' % i
